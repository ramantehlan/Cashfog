...
of creating a account 


Association:- create_ledger_account.fragment.php
creator:- Raman Tehlan
date of creation:- 25/12/2016
*********************************/

$(document).ready(function(){

	//on clicking the submit button
	$(".submit_account_creation_button").click(function(){
			...
			var account_comment		= document.getElementById("account_comment").value;
				...
				success_box.hide();
									...
									else if(!number_amount_validity(opening_balance)){
										throw_error(error_box , error_box , "opening balance " + number_field_error);
									}
				...
				if(allow_creating){
                	 ...
                	 ajax.open("POST",$("#create_ledger_account_form").attr("action"));

                	 ajax.send(formdata);

          			//to empty the form after the creation of account
					...
					document.getElementById("due_days").value 			= "";
					...
					document.getElementById("account_comment").value 	= "";
