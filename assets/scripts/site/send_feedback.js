 	   		  	...
 	   		  	$("document").ready(function(){
 	   		  		$("#form_button").click(function(){
 	   		  			...
 	   		  			var response_3 	= document.getElementById('response_3').value;
						...
						if(name.length == 0 || email.length == 0 || response_1.length == 0 || response_2.length == 0 || response_3.length == 0)
						  {
						  ...
						  else
						  {
						  	...
						  	$.post($("#form").attr("action") , {name:name,email:email,response_1:response_1,response_2:response_2,response_3:response_3 ,feedback:feedback,'g-recaptcha-response':recaptcha} , function(response){
